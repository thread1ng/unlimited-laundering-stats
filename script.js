...
// Fetch the Total Community Count and Handle Daily Change Logic
async function fetchTotalCommunityCount() {
  try {
    ...
    if (savedDay !== today) {
      // New day, reset and track today’s count
...
// Retry Button Logic (if fetch fails)
